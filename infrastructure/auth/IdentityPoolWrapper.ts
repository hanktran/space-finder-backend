...
export class IdentityPoolWrapper {
  ...
  private indentityPool: CfnIdentityPool;
  ...
  private initializeIdentityPool() {
    this.indentityPool = new CfnIdentityPool(
      this.scope,
    ...
    this.authenticatedRole = new Role(
      ...
      "CognitoDefaultAuthenticatedRole",
      {
        assumedBy: new FederatedPrincipal(
          ...
          {
            StringEquals: {
              "cognito-identity.amazonaws.com:aud": this.indentityPool.ref,
            },
  ...
  private attachRoles() {
    new CfnIdentityPoolRoleAttachment(this.scope, "RolesAttachment", {
      identityPoolId: this.indentityPool.ref,
      roles: {
